...
#         file.save(file_path)
#         rag=RAGProcessor(pdf_path=file_path, vector_db_collection_name="my_vector_collection",groq_api_key="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")
...
# def get_query():
#     # Access the 'input_string' query parameter
...
#     # Process the string (for example, just returning it in uppercase)
